...
一般的な服の管理アプリはファッション(主にクローゼットの中身・コーディネート)に特化しているものが多いため「QOL（生活の質）を上げるための服の管理」という視点からアプリ開発をしたいと考えました。特にこの「同じ人に会う時に同じ服を見せたくない」という悩みは複数のお相手と同時進行でやり取りをしており、誰にどの服を着て会ったかわからなくなるけれども服装が前回と被ると気まずい婚活中の方の悩み解決になると考えました。
...
このアプリ開発を通じて単純な服の管理ではなく自身の生活スタイルの見直しや、人間関係の悩み解決に対してのサポートができたらと思いました。
